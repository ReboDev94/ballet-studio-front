...
export const DEFAULT_ITEM_LIST_GROUP_CLASSES =
  'h-[42px] px-2 py-1 flex text-base-500 group first:hover:rounded-t-lg last:hover:rounded-b-lg';

const BASE_ITEM_CLASSES = 'hover:bg-base-100 hover:text-base-600 fill-base-600';
const PRIMARY_ITEM_CLASSES =
...
export const ICON_ITEM_CLASSES =
  'fill-base-500 h-full w-5 group-hover:fill-inherit';
