...
export const ITEM_SIDEBAR_CLASSES =
  'group cursor-pointer rounded-md py-3 px-4 flex text-base-400  hover:font-semibold';
...
const PRIMARY_ITEM_SIDEBAR_ICON = 'group-hover:fill-primary-800';

export const TYPE_ITEM_SIDEBAR = {
  primary: PRIMARY_ITEM_SIDEBAR_CLASSES,
};

export const TYPE_ACTIVE_ITEM_SIDEBAR = {
  primary: PRIMARY_ACTIVE_ITEM_SIDEBAR_CLASSES,
};

export const TYPE_ICON_ITEM_SIDEBAR = {
  primary: PRIMARY_ITEM_SIDEBAR_ICON,
};
