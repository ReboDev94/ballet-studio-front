...
import { IDataStudents, IGetStudentsRequest } from '@/ballet/interfaces';
import { useAppDispatch } from '@/store/hooks';
import { getAllStudentThunk } from '@/store/modules/student/thunks';
            ...
            {data.length > 0 &&
              data.map(user => (
                <Table.Row hover key={user.id}>
                  ...
                  <Table.Td>{user.tutor.celPhone}</Table.Td>
                  <Table.Td>{user.tutor.email}</Table.Td>
                  <Table.Td>
